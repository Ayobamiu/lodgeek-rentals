              ...
              <div className="container px-4 mx-auto">
                ...
                <div className="p-6 mx-auto bg-white border border-coolGray-100 rounded-md shadow-dashboard">
                  ...
                  <p className="text-xs font-medium text-coolGray-500 my-2">
                    After receiving rent payments on Lodgeek, you can choose to
                    either receive direct remittance to your bank account or use
                    the withdraw button on your wallet page to transfer the
                    funds to your account. Please note that both processes
                    attract transfer charges as follows: Transfers of NGN 5,000
                    and below - NGN 10 per transfer, Transfers between NGN 5,001
                    and NGN 50,000 - NGN 25 per transfer, Transfers above NGN
                    50,000 - NGN 50 per transfer. Please select your preferred
                    option and follow the necessary steps to complete the
                    transfer. If you need any assistance, please don't hesitate
