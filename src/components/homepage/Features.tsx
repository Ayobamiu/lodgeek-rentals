    ...
    >
      <div className="container px-4 mx-auto">
        ...
        <div className="relative mb-8 md:mb-24 mx-auto max-w-max">
          <Circle3yellow className="absolute z-10 -left-8 -top-8 w-28 md:w-auto text-yellow-400" />
          <Dots3blue className="absolute z-10 -right-7 -bottom-8 w-28 md:w-auto text-blue-500" />
          <img src={Stock3} alt="" />
        </div>
