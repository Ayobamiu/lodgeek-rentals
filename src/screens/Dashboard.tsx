...
import PaymentHistory from "./DashboardTabs/PaymentHistory";
...
export default function Dashboard() {
  ...
  return (
    <div className="">
      <section className="overflow-hidden">
        <div>
          <div className="px-8 py-6 xl:py-0 bg-coolGray-900 border-b border-coolGray-100">
            <div className="flex items-center justify-between -m-2">
              <div className="flex flex-wrap items-center w-auto p-2">
                <Link className="block max-w-max xl:mr-14" to="/">
                  <FlexUIGreenLight className="h-10 w-[95px]" />
                </Link>
                <ul className="hidden xl:flex flex-wrap">
                  <li className="mr-8">
                    <Link
                      ...
                      to="/dashboard?tab=rentalRecords"
                    >
                      <svg
                        className="mr-2"
                        width="24"
                  ...
                  {/* <li className="mr-8">
                    ...
                    >
                      ...
                      <p className="text-white">Rents</p>
                    </Link>
                  </li>
                  <li className="mr-8">
                    <Link
                      ...
                      to="/dashboard?tab=paymentHistory"
                    >
                      <svg
                        className="mr-2"
                        width="24"
                      ...
                      <p className="text-white">Payment History</p>
                    </Link>
                  </li> */}
                </ul>
              </div>
              <div className="w-auto p-2">
                <div className="hidden xl:flex flex-wrap items-center -m-3">
                  <div className="w-auto p-3">
                    <Link
                      className="block max-w-max text-coolGray-500 hover:text-coolGray-600"
                      to="#"
                    >
                      <svg
                        width="24"
          ...
          <div
            className={`${
              navOpen ? "flex" : "hidden"
            } navbar-menu z-50 fixed top-0  xl:hidden flex-col justify-between bg-coolGray-900 max-w-xs w-9/12 h-full overflow-y-auto`}
          >
            <div
              className="navbar-backdrop fixed xl:hidden inset-0 bg-coolGray-900 opacity-60"
              onClick={toggleNav}
            ></div>
            <div className="relative bg-coolGray-900 flex-1">
              ...
              <div className="mt-28">
                <p className="px-8 mb-2 text-xs font-medium text-coolGray-500 uppercase">
                  Main menu
                </p>
                <ul className="px-4 mb-8">
                  {/* <li>
                    <Link
                      className="p-3 py-4 flex items-center justify-between text-coolGray-500 hover:text-green-500 hover:bg-coolGray-800 rounded-md"
                      to="#"
                    >
                  ...
                  <li>
                    <Link
                      className="p-3 pl-11 flex items-center justify-between"
                      to="#"
                    >
                      <div className="flex items-center">
                        <p className="text-white font-medium text-base">
                  ...
                  <li>
                    ...
                    >
                      <div className="flex items-center">
                        <p className="text-coolGray-500 font-medium text-base">
                          Notifications
                        </p>
                      </div>
                    </Link>
                ...
                <div>
                  ...
                  <div className="fixed bottom-0 -left-4 max-w-xs w-full flex flex-wrap items-center p-6 pl-10 justify-between bg-coolGray-900">
      ...
      {query.get("tab") === "rentalRecords" && <RentalRecords />}
      {query.get("tab") === "rentalRecordDetails" && <RentalRecordDetails />}
      {query.get("tab") === "addRentalRecords" && <AddRentalRecords />}
      {query.get("tab") === "addProperty" && <AddProperty />}
